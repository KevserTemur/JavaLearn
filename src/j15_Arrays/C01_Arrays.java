 ...
 */
        ...
        int sayiArr[] = new int[0]; // declare (tanımlanan) edilen ama atanmayan int type array
...
// Array elemanları naturel (k>b (ascendig) alfabetik b>k (descending) sıralama
